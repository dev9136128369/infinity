  ...
  return (
    ...
    <div class="page-title">
        ...
        <div className="slider-header">
          <h2 className="slider-title">Terms & Conditions</h2>
          <p className="slider-subtitle">Please read these terms carefully before using our services</p>
    ...
    <div class="container">
        <div class="content-container">
            ...
            <div className="highlight-box">
              ...
              <p><strong>Financial & Administrative Support –</strong> We have a dedicated team which aids the customer for Mortgage & Financial services, Administrative & Legal support.</p>
              <p><strong>Product Portfolio –</strong> We cater into all kinds of properties; categorized as Residential (primary & resale), Commercial, Leasing, Land, Affordable Housing, Investor Projects, Structured offerings etc.</p>
              <p><strong>Portfolio Structuring & Management-</strong> We help in diversifying our clients' real estate portfolios and are pioneers in bringing Properties with the best payout options to Indian investors.</p></div>
                    </div>
                    </div>
                </section>
            ...
            <ol>
              <li style={{listStyleType: 'none'}}>
                <ol>
                  ...
                  <li>The Transaction between the Parties, if any, concludes to the satisfaction of both Parties; Whichever is longer. The Parties agree that certain portions of these Terms ("Sections"), such as Sections 12, 13, 14, & 16, shall continue to remain in full force and effect indefinitely, even after the expiry or termination of these Terms as contemplated herein.</li>
                </ol>
              </li>
            </ol>
                    </div>
                ...
                <ol>
                  ...
                  <li>Further undertakes not to:
                    <ol>
                      ...
                      <li>Threaten the unity, integrity, defense, security or sovereignty of India, friendly relations with foreign states, or public order, or cause incitement to the commission of any cognizable offence, or prevent the investigation of any offence, or insult any other nation.</li>
...
<section id="dispute" class="section">
           ...
           <p>It is expressly agreed to by the Parties hereto that the formation, interpretation and performance of these Terms and any disputes arising here from will be resolved through a two-step Alternate Dispute Resolution ("ADR") mechanism. It is further agreed to by the Parties that the contents of this Section shall survive even after the termination or expiry of the Terms and/or Policy.</p>
            ...
            <p>The Parties expressly agree that the Terms, Policy and any other agreements entered into between the Parties are governed by the laws, rules and regulations of India, and that the Courts at New Delhi shall have exclusive jurisdiction over any disputes arising between the Parties.</p>
                </div>
                </section>
