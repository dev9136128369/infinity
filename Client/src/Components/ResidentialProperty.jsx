  ...
  return (
    <section className="hero">
      <section className="side-section">
        ...
        <div className="side-image">
          <img src="/Images/Resdient4.jpeg" alt="Residential Property" />
        </div>
      </section>
    </section>
  );
    ...
    <section className="newsletter">
      <div className="container">
        ...
        <p className="slider-subtitle">
          Subscribe to our newsletter to receive updates on new residential properties and investment opportunities.
        </p>
        <form className="newsletter-form" onSubmit={handleSubmit}>
          <input 
            type="email" 
...
const ResidentialPropertiesPage = () => {
  ...
  const residentialProperties = properties.filter(prop => 
    prop.category === 'RESIDENTIAL PROPERTY'
  );
  ...
  const hasMoreProperties = visibleCount < residentialProperties.length;
    ...
    return (
      <div className="residential-properties-page">
        ...
        <div className="loading-container">
          <div className="loading-text">Loading residential properties...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="residential-properties-page">
      ...
      {/* MAIN RESIDENTIAL PROPERTIES SECTION */}
      <div className="container">
        <section className="property-listings">
          <div className="slider-header">
            <h2 className="slider-title">MOST TRENDING RESIDENTIAL PROPERTIES</h2>
            <p className="slider-subtitle">
             Discover the residential properties that everyone is talking about — blending smart designs, vibrant communities, and excellent returns on investment.
            </p>
          </div>

          {/* Properties Count */}
          <div className="properties-count">
            Showing {Math.min(visibleCount, residentialProperties.length)} of {residentialProperties.length} residential properties
          </div>

          {residentialProperties.length === 0 ? (
            <div className="no-properties">
              No residential properties found. Check back later for new listings.
            </div>
          ) : (
            <>
              <div className="properties-grid">
                {residentialProperties.slice(0, visibleCount).map(property => (
              ...
              {hasMoreProperties && (
                <div className="load-more-container">
                  <button onClick={loadMore} className="load-more-btn">
                    Load More Properties ({residentialProperties.length - visibleCount} remaining)
                  </button>
                </div>
              )}

              {/* Show message when all properties are loaded */}
              {!hasMoreProperties && residentialProperties.length > 0 && (
                <div className="load-more-container">
                  <p style={{color: 'var(--gray)', fontSize: '1.1rem'}}>
                     All {residentialProperties.length} residential properties loaded!
                  </p>
                </div>
              )}
            </>
